...
export default function ApartmentDetailsPage() {
  ...
  if (loading || !reportData) return <Loader />;
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-red-50 rounded-lg border border-red-200">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600">Distress Value</span>
                </div>
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-sm text-gray-600">Case Reference No.</p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="font-semibold text-lg">{reportData.owner_name}</p>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="font-semibold">{reportData.property_address}</p>
              </div>

              <div>
                <p className="text-sm text-gray-600 mb-1">Nearest Landmark</p>
                <p className="font-semibold">{reportData.nearest_landmark}</p>
              </div>
            </CardContent>
          </Card>
        </div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 gap-6">
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className="font-semibold">
                    {reportData.super_built_up_area} sq ft
                  </span>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className="font-semibold">{reportData.loading}</span>
                </div>
              </div>
            </CardContent>
          </Card>
